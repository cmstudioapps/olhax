...
module.exports = {
  ...
  encontrarTexto: vision.encontrarTexto,
  findText: vision.findText,
  procurarTexto: vision.procurarTexto,
  searchText: vision.searchText,
  encontrarTextos: vision.encontrarTextos,
  findAllText: vision.findAllText,
  compararTexto: vision.compararTexto,
  compareText: vision.compareText,
  ...
  clicar: mouse.clicar,
  click: mouse.click,
  clicarTexto: mouse.clicarTexto,
  clickText: mouse.clickText,
